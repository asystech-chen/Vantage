...
process-type-web = 网内容

process-type-privilegedabout = 有特权的关于

process-type-privilegedmozilla = 有特权的摩斯拉内容

process-type-extension = 扩展名

process-type-file = 本地的文件

process-type-forkserver = 派生指令服务器

process-type-webisolated = 隔离的网内容

process-type-webserviceworker = 隔离的服务工人

process-type-prealloc = 预分配的


process-type-default = 主群组
