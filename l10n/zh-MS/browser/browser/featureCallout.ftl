...
callout-primary-advance-button-label = 近邻干扰

# Callout dialog primary button to complete the feature tour
callout-primary-complete-button-label = 获得它!
...
continuous-onboarding-firefox-view-tab-pickup-title = 推进你的浏览与标签页拾起

continuous-onboarding-firefox-view-tab-pickup-subtitle = 访问你的打开标签页从任何的装置. 正差同步的你的书签, 密码, 和更多.

continuous-onboarding-firefox-view-tab-pickup-primary-button-label = 获得启动
...
sidebar-button-callout-title = 显示标签页标题在那其他选项
...
vertical-tabs-callout-2-title = 保持一个运气的标签页打开? 尝试垂直的标签页.
vertical-tabs-callout-2-subtitle = 这页面布局使它容易的到很快地网络软件目录你的列表的标签页. 正差, 你能调整那宽度到看见更多或最低成本估算与调度法的你的标签页标题.

## Sidebar Vertical Tabs Pinning Strings

sidebar-pins-callout-title = 损失的跟踪的你的要点标签页?
sidebar-pins-callout-subtitle = 尝试阻塞他们, 哪个保持他们在那 TOP协议的你的列表的标签页. 右-click 在一个标签页你想要到将...用针别住, 然后选取大头针 Tab.
sidebar-pins-callout-cta-button = 大头针标签页

## Pinning Tabs Strings

pin-tabs-callout-1-title = 保持要点标签页内部伸出
pin-tabs-callout-1-subtitle = 拖动一个标签页到那启动的那标签页长条到将...用针别住它. 或右-click 和选取大头针 Tab.
pin-tabs-callout-cta-1-button = 大头针这标签页
...
sidebar-customization-callout-2-subtitle = 添加和移除工具. 地方你的标签页在那其他选项. 弹性一个 AI chatbot 一个尝试. 如何你定制你的其他选项是向上的到你.

## Sidebar Callout Survey Strings

sidebar-callout-survey-title = 帮忙改良 { -brand-short-name }
sidebar-callout-survey-satisfaction-question = 如何感到满意的是你与那其他选项经历在 { -brand-short-name }?
sidebar-callout-survey-privacy-notice-link = 隐私注意
sidebar-callout-survey-very-satisfied = 真正的感到满意的
sidebar-callout-survey-satisfied = 感到满意的
sidebar-callout-survey-neutral = 中立者
sidebar-callout-survey-dissatisfied-2 = 不满的
sidebar-callout-survey-very-dissatisfied-2 = 真正的不满的
sidebar-callout-survey-dont-use-it = 电流不要使用它
sidebar-callout-survey-productive-question =
    到什么范围做你同意或不一致与这程序语句:<br/>
    “那 { -brand-short-name } 其他选项帮忙我是更多能生产的”?
sidebar-callout-survey-strongly-agree = 强有力地同意
sidebar-callout-survey-agree = 同意
sidebar-callout-survey-disagree = 不一致
sidebar-callout-survey-strongly-disagree = 强有力地不一致
sidebar-callout-survey-features-question = 那下列各项是潜在性其他选项特性. 哪个会改良你的生产力在 { -brand-short-name } 那最多?
sidebar-callout-survey-split-view = 查看任何的二网站（全球资讯网的主机站）在一次, 在一个旁边-by-side 拆分查看
sidebar-callout-survey-keep-website-open = 保持一个网站（全球资讯网的主机站）, 相似的电子信函或日历, 打开在那其他选项作为你浏览
sidebar-callout-survey-saved-websites-2 = 快的访问到你的书签
sidebar-callout-survey-none-of-above = 一点也不的那在上方
sidebar-callout-survey-submit = 提交
sidebar-callout-survey-thank-you = 谢意你为了你的反馈!

# Sidebar GenAI Survey Strings

sidebar-genai-survey-satisfaction-question = 如何感到满意的是你与财产访问到一个 AI chatbot 在那其他选项?
sidebar-genai-survey-productive-question =
    到什么范围做你同意或不一致与这程序语句:<br/>
    “那 AI chatbot 在那其他选项帮忙我是更多能生产的”?
...
unified-search-engines-callout-title = 搜索与一个快捷方式
unified-search-engines-callout-subtitle = 类型“@”跟随的由一个关键字到搜索你的历史记录, 书签, 标签页, 或与另外的搜索引擎.
unified-search-engines-callout-primary-label = 获得它

actions-callout-title = 完全的公用块任务或访问基本原理设置
...
actions-callout-subtitle = 尝试键入一个操作相似的“打印”到打印一个页, 或“清除”到清除你的历史记录.
...
bookmarks-toolbar-callout-1-title = 添加此站点到你的书签工具栏?
bookmarks-toolbar-callout-1-subtitle = 你的书签将是保存只是在下面那地址棒形图为了新长出的肉访问.
...
perplexity-callout-secondary-label-1 = 解散
perplexity-callout-secondary-label-2 = 获得它
...
start-page-callout-title = 想要到试一个新的隐私-focused 搜索?
start-page-callout-subtitle = 尝试 Startpage. 它是故意的到保持你的搜索更多私人的从那启动.
start-page-callout-primary-label = 尝试 Startpage
start-page-callout-secondary-label = 解散
...
windows-10-eos-sync-new-device-subtitle-1 = 同步的到采取你的 { -brand-short-name } 书签, 密码, 和首选的设置与你何时你移动.
windows-10-eos-sync-new-device-title-2 = 动人的到一个新的装置? 不要遗失什么事件.
...
windows-10-eos-sync-split-dismiss-button-show-fewer-option =
    .label = 显示较少的推荐
windows-10-eos-sync-dismiss-button-label = 解散
windows-10-eos-sync-callout-primary-advance-button-label = 近邻干扰

## Link Preview Onboarding message callout strings

link-preview-onboarding-callout-title = 新的: 单击和保留到预览连接
link-preview-onboarding-callout-description = 看见一个扼要描述, 阅读时间, 和更多到决定如果一个连接是价值那单击. 也可利用的在右-click.
...
tab-groups-2026-onboarding-callout-title = 剪切那杂乱与标签页创建组
...
tab-groups-2026-onboarding-callout-subtitle = 创建组你的标签页由任务或主题. 拖动更多在作为你去.
...
tab-groups-2026-onboarding-cta-button = 启动一个创建组
