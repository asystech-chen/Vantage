...
places-bookmarks-restore-alert = 这将代替所有的的你的当前的书签与那倒车. 你确定?
places-bookmarks-restore-title = 选择一个书签倒车
places-bookmarks-restore-filter-name = JSON
places-bookmarks-restore-format-error = 未经证实的文件类型.
places-bookmarks-restore-parse-error = 不能的到进程那倒车文件.

places-bookmarks-import = 引入书签文件
