...
graph-private-window = { -brand-short-name } 继续到阻止追踪者在私人的窗, 除了做不保持一个录制的什么曾是阻止.
...
protection-report-page-summary = { -brand-short-name } 能防卫你的隐私在后地那场一会儿你浏览. 这是一个个人化的摘要的那些保护, 包含工具到采取控制的你的联机安全.
# This message shows when at least some protections are turned on, we are more assertive compared to the message above, Firefox is actively protecting you.
protection-report-page-summary-default = { -brand-short-name } 防卫你的隐私在后地那场一会儿你浏览. 这是一个个人化的摘要的那些保护, 包含工具到采取控制的你的联机安全.
...
cookie-tab-content = 这些饼干跟随你从位置到给...择址到聚集论据关于什么你做联机. 他们是日落由第三宴会如此的作为做广告者和分析的公司. 组成块交叉-site 跟踪饼干缩小那数字的精确定义系统那跟随你包围. <a data-l10n-name="learn-more-link">学习更多</a>

tracker-tab-title = 跟踪内容
tracker-tab-description = 网站（全球资讯网的主机站）可以加载外部精确定义系统, 影像, 和其他的内容与跟踪代码. 组成块跟踪内容能帮助位置加载加快, 除了一些按钮, 表单, 和注册(程序) 域可能不工作. <a data-l10n-name="learn-more-link">学习更多</a>
...
cryptominer-tab-content = Cryptominers 使用你的 system's 计算功率到挖掘数字金钱. Cryptomining 手写体排水沟你的电池, 慢的向下你的计算机, 和能增加你的精力帐单. <a data-l10n-name="learn-more-link">学习更多</a>

protections-close-button2 =
  .aria-label = 关闭
  .title = 关闭

mobile-app-title = 阻止地址追踪者越过更多装置
...
passwords-header-content = { -brand-product-name } 安全地存储器操作你的密码在你的浏览器中.
lockwise-header-content-logged-in = 安全地存储器操作和同步的你的密码对所有人你的装置.
...
lockwise-scanned-text-breached-logins =
  { $count ->
      [one] 1 密码可以有是暴露的在一个论据裂口.
     *[other] { $count } 密码可以有是暴露的在一个论据裂口.
  }
...
monitor-title = 一看外面的为了论据裂口
monitor-link = 如何它工作
monitor-header-content-no-account = 复选 { -monitor-brand-name } 到看见如果你有是部分的一个已知的论据裂口, 和获得警觉的关于新的裂口.
monitor-header-content-signed-in = { -monitor-brand-name } 警告你如果你的信息有出现在一个已知的论据裂口.
...
monitor-breaches-tooltip =
  .title = 查看已知的论据裂口在 { -monitor-brand-short-name }
...
info-known-breaches-resolved =
  { $count ->
     [one] 已知的论据裂口有记号的作为下定决心的
    *[other] 已知的论据裂口有记号的作为下定决心的
  }
...
monitor-breaches-unresolved-description = 在...之后检验裂口详细数据和取得步骤到防卫你的信息, 你能标志裂口作为下定决心的.
monitor-manage-breaches-link = 管理裂口
  .title = 管理裂口在 { -monitor-brand-short-name }
monitor-breaches-resolved-title = 美好的! 你有下定决心的所有的已知的裂口.
...
privacy-metrics-private-window = { -brand-short-name } 继续到阻止追踪者在私人的窗, 除了做不保持一个录制的什么曾是阻止.

## VPN promo card and banner

protections-vpn-title = 采取隐私保护超过那浏览器
protections-vpn-header-content = 防卫你的整个装置与 { -mozilla-vpn-brand-name }. 一(个) 接头加密所有的通信量和隐藏你的位置.
protections-get-vpn-link = 获得 { -mozilla-vpn-brand-name }

protections-vpn-title-subscribed = VPN: 捐助
# Variables
#   $count (number): Number of devices
protections-vpn-header-content-subscribed =
    { $count ->
       *[other] 使用那 { -mozilla-vpn-brand-name } 加密所有的你的通信量和隐藏你的位置—在向上的到 { $count } 装置. 获得那最多从你的捐献—添加它从那 <a data-l10n-name="playstore-link">谷歌播放存储器操作</a> 或 <a data-l10n-name="appstore-link">苹果应用存储器操作</a>.
    }

protections-vpn-banner-header = 保护那扩展超过那浏览器
protections-vpn-banner-content = 尝试 { -mozilla-vpn-brand-name } 冒险-free 和看见为什么 TechRadar 说, “它的中央处理机速度设置程序, 简明性和低点月刊价格使它价值一个一看.”
