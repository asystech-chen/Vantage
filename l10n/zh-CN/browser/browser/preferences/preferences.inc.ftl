...
vantage-update-checkbox =
    .label = 自动检查更新
vantage-update-description = 启动时自动检查 Vantage 是否有新版本。发现新版本时会在窗口顶部显示通知，但不会自动安装更新。

vantage-ai-heading = AI 侧边栏
vantage-ai-checkbox =
    .label = 在侧边栏启用 AI（实验功能）
vantage-ai-description = 启用后，您可以在浏览器侧边栏中使用 AI 聊天助手。此功能将在侧边栏面板中加载第三方 AI 服务。
